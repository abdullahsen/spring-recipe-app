package com.iafnstudios.springrecipeapp.bootstrap;

import com.iafnstudios.springrecipeapp.domain.*;
import com.iafnstudios.springrecipeapp.repository.CategoryRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        ...
        log.debug("Startup data is loading");
    }
